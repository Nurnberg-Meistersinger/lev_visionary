...
2. Выбрать только те твиты, чья важность >= 6. Если твитов слишком много, выбери не более {top_n} самых важных.
...
3. По каждому выбранному твиту выдать:
   ...
   • КОРОТКИЙ TLDR - одна фраза в формате "О [тема]", максимум 50 символов, по-русски
